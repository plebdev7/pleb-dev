from ._anvil_designer import TemplateClickUpgradeTemplate
from anvil import *

from ..ClickGame import CG

class TemplateClickUpgrade(TemplateClickUpgradeTemplate):
    ...
    def update_display(self):
        ...
        self.button_buy.text = f"cost: {cost} clicks"
        ...
        self.button_buy.enabled = CG.click_points >= cost
    
    def button_buy_click(self, **event_args):
        """This method is called when the button is clicked"""
        self.button_buy.enabled = False
        CG.click_points -= self.item.current_cost()
        self.item.count += 1
